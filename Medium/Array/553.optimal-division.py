...
You are given an integer array nums. The adjacent integers in nums
...
change the priority of operations. You want to add these parentheses
such the value of the expression after the evaluation is maximum.
...
since they do not influence the operation priority.
...
class Solution:
    def optimalDivision(self, nums: List[int]) -> str:
        ...
        middle = "/".join(str(value) for value in nums[1:])
