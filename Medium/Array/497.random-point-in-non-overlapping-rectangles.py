...
rects where rects[i] = [ai, bi, xi, yi] indicates that (ai, bi) is the
...
pick a random integer point inside the space covered by one of the
given rectangles. A point on the perimeter of a rectangle is included
