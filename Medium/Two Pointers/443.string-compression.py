...
lengths that are 10 or longer will be split into multiple characters
in chars.
...
"a2b2c3".
After modifying the input array in-place, the first 6 characters of
chars should be ["a","2","b","2","c","3"].
...
After modifying the input array in-place, the first character of
chars should be ["a"].
...
to "ab12".
After modifying the input array in-place, the first 4 characters of
