...
We define that string s1 can be obtained from string s2 if we can
...
class Solution:
    def getMaxRepetitions(self, s1: str, n1: int, s2: str, n2: int) -> int:
        ...
        while count1 < n1:
            ...
            count1 += 1
            if index in seen:
                previous1, previous2 = seen[index]
                cycle1 = count1 - previous1
                cycle2 = count2 - previous2
                remaining = n1 - count1
                count2 += (remaining // cycle1) * cycle2
                count1 += (remaining // cycle1) * cycle1
                seen.clear()
            else:
