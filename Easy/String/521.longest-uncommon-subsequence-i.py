...
Input: a = "aba", b = "cdc"
Output: 3
Explanation: One longest uncommon subsequence is "aba" because "aba"
is a subsequence of "aba" but not "cdc".
...
string b. Similarly, every subsequence of string b is also a
