...
Teemo attacks Ashe, Ashe gets poisoned for a exactly duration seconds.
...
again before the poison effect ends, the timer for it is reset, and
...
- At second 1, Teemo attacks, and Ashe is poisoned for seconds 1 and
2.
- At second 4, Teemo attacks, and Ashe is poisoned for seconds 4 and
5.
